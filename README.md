...
- <font color=#FF0000>此项目是Fork **bingoogolapple的https://github.com/bingoogolapple/BGASwipeBackLayout-Android** 
- ①修复Android 9.0系统侧滑返回会出现闪屏的bug
- ②切换为AndroidX库。
- 如需查看修复效果，请自行下载Demo运行，下方提供的二维码是bingoogolapple的release版</font>
...
groovy
dependencies {
    implementation 'com.github.Jasongq:BGASwipeBackLayout-AndroidX:v1.2.1-alpha'
}
```
